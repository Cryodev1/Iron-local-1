...
if(apps[app].title === "DevTools") {
  appelm.setAttribute("onclick", "javascript:(function () {var a = document.createElement('script');a.src = '/thing/vapor.min.js';document.body.appendChild(a);}())")
}
...
document.getElementById("nav2").appendChild(appelm)
}
}
